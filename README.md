...
폐와 기도, 실내 공기에 영향을 준다고 알려진 것들을 실제로 재본 연구들입니다.

**잡학 01 · 발암물질은 줄었는데, 다른 게 12.8배 늘었다**

담뱃잎을 온도별로 가열해 나오는 화합물을 비교한 실험입니다. 니코틴을 기준으로 맞췄을 때 궐련형 전자담배의 발암 위험도는 일반담배 대비 50% 이상 낮았고, 대신 알코올류 화합물은 12.8배 많이 나왔습니다.

- 연구 설계: 열분해 실험 · GC/MS
- 핵심 수치: 12.8배 — 알코올류 화합물 증가량 (궐련형 전자담배용 잎 기준)
...
33.8㎥ 흡연 부스에서 실제로 재봤더니 궐련형 전자담배의 총 휘발성유기화합물은 일반담배의 약 11분의 1이었습니다. 같은 연구에 튀김·구이 같은 조리 배출이 포름알데히드를 더 많이 낼 수 있다는 비교도 함께 실렸습니다.

- 연구 설계: 흡연 부스 실측 · 33.8㎥
- 핵심 수치: 11배 — 총 휘발성유기화합물(TVOC) 농도 차이 (밀폐·6개비)
...
생활 습관이나 제품 전환이 심혈관계 결과와 어떻게 연관되는지 대규모로 추적한 연구들입니다.

**잡학 03 · 비교 대상만 바꿨더니 숫자가 뒤집혔다**

같은 사람들을 두고 무엇과 비교하느냐에 따라 결과가 반대로 나온 연구입니다. 지속 흡연자와 비교하면 전환자의 심혈관 위험이 낮았고, 금연자와 비교하면 높았습니다.

- 연구 설계: 전국 코호트 · 515만 명
- 핵심 수치: 0.81 → 1.31 — 비교 기준을 지속 흡연에서 금연으로 바꿨을 때
...
스텐트 시술을 받은 흡연자를 추적했더니, 전자담배로 완전히 넘어간 사람과 일반담배를 함께 피운 사람 사이에 심장 부작용 발생이 갈렸습니다.

- 연구 설계: 관상동맥중재술 후 코호트 · 17,973명
- 핵심 수치: 0.71 — 완전 전환자의 심장 부작용 위험 (이중사용=1.0)
...
간을 비롯한 대사 기관의 장기 결과와 행동 변화를 함께 추적한 연구입니다.

**잡학 05 · 간암 위험은 같았는데, 3년 뒤 행동은 달랐다**

만성 B형간염 환자를 추적했더니 금연군과 전자담배 전환군 모두 지속 흡연군보다 간암 발생 위험이 22% 낮게 관찰됐습니다. 다만 시간이 지난 뒤 실제 금연에 도달한 비율은 두 집단이 크게 달랐습니다.

- 연구 설계: 만성 B형간염 코호트 · 127,196명
- 핵심 수치: 12% vs 61% — 3차 검진 시점의 금연 유지·도달 비율
...
디스크·무릎처럼 통증과 퇴행성 변화가 걸린 부위에서, 습관이 실제로 어떤 숫자로 나오는지 본 연구들입니다.

**잡학 06 · '전자담배'로 묶으면 안 보이는 게 있었다**

척추 디스크 질환 위험을 봤더니 전자담배 종류에 따라 숫자가 갈렸습니다. 궐련형 전자담배로 바꾼 쪽은 지속 흡연보다 낮았고, 액상형으로 바꾼 쪽은 지속 흡연과 거의 같았습니다.

- 연구 설계: 전국 코호트 · 326만 명
- 핵심 수치: 0.89 vs 1.01 — 궐련형 전자담배 전환자와 액상형 전환자의 디스크 위험
...
달리기가 무릎 관절염을 악화시키는지 본 단기 추적 연구들을 종합했더니, 인공관절 치환술로 진행한 비율은 러너 쪽이 더 낮았습니다.

- 연구 설계: 체계적 문헌고찰 · 메타분석
- 핵심 수치: 2.6% — 러너의 무릎 인공관절 치환술 진행률 (비러너 4.6%)
...
얼마나 자는지, 어떻게 자는지를 서로 다른 방법으로 재본 연구들입니다. 재는 방법이 결론을 바꾸기도 합니다.

**잡학 08 · 설문지가 적은 잠과 손목이 잰 잠이 달랐다**

같은 코호트를 두 방식으로 분석했더니 결론이 갈렸습니다. 설문으로 조사한 연구는 주말 몰아자기 그룹의 심장병 위험이 낮다고 했고, 손목 기기로 실측한 연구는 그 연관성을 찾지 못했습니다.

- 연구 설계: UK 바이오뱅크 코호트 비교
- 핵심 수치: 20% ↔ 0 — 설문 기반 결과와 기기 측정 기반 결과
...
알코올과 수면 구조의 관계를 다룬 연구 27건을 종합했습니다. 잠드는 속도가 빨라지는 효과는 많이 마셨을 때만 나타났고, REM 수면 감소는 적게 마셔도 나타났습니다.

- 연구 설계: 메타분석 · 연구 27건
- 핵심 수치: 약 2잔 — REM 수면이 줄기 시작한 저용량 기준
...
체중과 식습관을 둘러싼 통념을 무작위 배정 실험으로 확인한 연구들입니다.

**잡학 10 · 아침을 거른 쪽이 0.54kg 더 줄었다**

4주 이상 진행된 무작위 대조시험 7건을 종합했더니, 아침을 거른 그룹의 체중이 오히려 소폭 더 줄었습니다. 같은 조건에서 LDL 콜레스테롤은 올라간다는 보고가 함께 있습니다.

- 연구 설계: 메타분석 · 무작위 대조시험 7건
- 핵심 수치: −0.54kg — 아침을 거른 그룹의 체중 변화 (먹은 그룹 대비)
...
609명을 12개월간 추적한 대규모 무작위 대조시험입니다. 저지방과 저탄수화물의 체중감량 결과에 유의한 차이가 없었고, 유전자형이나 인슐린 분비 수준도 그 결과를 바꾸지 못했습니다.

- 연구 설계: 무작위 대조시험 · 609명 · 12개월
- 핵심 수치: 차이 없음 — 저지방 식단과 저탄수화물 식단의 12개월 체중감량 차이
...
전체 목록 → [https://healthkeeper2026-lab.github.io/usefulknowledge/#s-papers](https://healthkeeper2026-lab.github.io/usefulknowledge/#s-papers)

1. **일반담배와 가열담배에서 발생하는 독성 열분해 생성물의 비교**  
   *Comparison of toxic pyrogenic compounds derived from conventional cigarettes and heated tobacco products* (2025)  
   Lee T, Park J, Kim Y, Chen W-H, Kwon EE. Journal of Hazardous Materials 493 (2025) 138357.
2. **궐련형 전자담배 흡연과 실내공기질 영향**  
   *The smoking of heat-not-burn (HNB) cigarette products and its effects on indoor air quality* (2025)  
   Lee Y-S, Lim D-H, Maitlo HA, Kim K-H. Journal of Hazardous Materials 496 (2025) 138790.
3. **한국 남성에서 전자담배 전환 및 금연에 따른 단기 심혈관질환 위험: 전국 단위 코호트 연구**  
   *Combined Associations of Changes in Noncombustible Nicotine or Tobacco Product and Combustible Cigarette Use Habits With Subsequent Short-Term Cardiovascular Disease Risk Among South Korean Men* (2021)  
   Choi S, Lee K, Park SM. Circulation. 2021;144:1528–1538.
4. **관상동맥질환 스텐트 시술 후 전자담배 전환에 따른 예후: 한국 전국 단위 연구**  
   *Prognosis after switching to electronic cigarettes following percutaneous coronary intervention: a Korean nationwide study* (2024)  
   Kang D, Choi KH, Kim H, et al. European Heart Journal (2024).
5. **만성 B형간염 환자에서 전자담배 전환과 금연에 따른 간암 발생 위험: 대한민국 전국 단위 코호트 연구**  
   *E-cigarette switching, smoking cessation, and the risk of hepatocellular carcinoma in patients with chronic hepatitis B: A nationwide cohort study in South Korea* (2026)  
   Song BG, Lee M, Cho J, Gwak G-Y, Kang D, Sinn DH. Preventive Medicine 205 (2026) 108530.
6. **전자담배 및 일반담배 사용과 척추 디스크 질환 위험: 전국 단위 코호트 연구**  
   *Electronic and Conventional Cigarette Use and Risk of Spinal Disc Disorders: A Nationwide Cohort Study* (2025)  
   Shin JW, Kwon J-W, Chun SY, et al. The Spine Journal (2025), in press.
7. **달리기가 무릎 골관절염 발생에 미치는 영향: 단기 추적 기준 최신 체계적 문헌고찰**  
   *Effects of Running on the Development of Knee Osteoarthritis: An Updated Systematic Review at Short-Term Follow-up* (2023)  
   Dhillon J, Kraeutler MJ, Belk JW, et al. Orthopaedic Journal of Sports Medicine. 2023.
8. **기기로 측정한 주말 보충수면과 사망률·심혈관질환 발생**  
   *Device-measured weekend catch-up sleep, mortality, and cardiovascular disease incidence in adults* (2024)  
   Chaput J-P, Biswas RK, Ahmadi M, et al. Sleep. 2024;47(11):zsae135. / 비교자료: Song Y, Liu Z, et al. ESC Congress 2024 발표.
9. **건강한 성인에서 음주가 이후 수면에 미치는 영향: 체계적 문헌고찰 및 메타분석**  
   *The effect of alcohol on subsequent sleep in healthy adults: a systematic review and meta-analysis* (2025)  
   Gardiner C, Weakley J, Burke LM, et al. Sleep Medicine Reviews. 2025;80:102030.
10. **아침 결식과 체구성·심대사 위험: 무작위 시험에 대한 체계적 문헌고찰 및 메타분석**  
   *Breakfast Skipping, Body Composition, and Cardiometabolic Risk: A Systematic Review and Meta-Analysis of Randomized Trials* (2020)  
   Bonnet JP, Cardel MI, Cellini J, Hu FB, Guasch-Ferré M. Obesity. 2020;28(6):1098-1109.
11. **과체중 성인에서 저지방 식단과 저탄수화물 식단의 12개월 체중감량 효과 및 유전자형·인슐린 분비와의 연관: DIETFITS 무작위 임상시험**  
   *Effect of Low-Fat vs Low-Carbohydrate Diet on 12-Month Weight Loss in Overweight Adults and the Association With Genotype Pattern or Insulin Secretion: The DIETFITS Randomized Clinical Trial* (2018)  
   Gardner CD, Trepanowski JF, Del Gobbo LC, et al. JAMA. 2018;319(7):667-679.

국문 제목은 이해를 돕기 위한 번역이며, 정확한 내용은 원문을 확인해 주세요.
...
| | |
|---|---|
| **출처** | 카드마다 실제로 발표된 연구를 근거로 삼고, 발표처·연도·핵심 수치를 함께 적습니다. |
| **형식** | 좋다·나쁘다로 요약하지 않습니다. 연구가 무엇을 쟀고 숫자가 얼마였는지를 그대로 적습니다. |
| **한계** | 연구가 스스로 밝힌 한계, 설계상 답할 수 없는 질문을 카드마다 따로 적어둡니다. |
| **태도** | 어떤 제품이나 요법도 권장하지 않습니다. |

### 인용하실 때

- 수치가 낮게 관찰됐다는 서술을 안전성·유효성의 근거로 인용해서는 안 됩니다.
- 각 항목의 '근데 이건 안 나온 얘기'와 '이렇게 읽으면 곤란함'은 함께 전달되어야 하는 한계 정보입니다.
- 관찰연구 기반 항목은 인과관계를 단정하지 않습니다.
...
이 사이트는 공개적으로 발표된 연구의 내용을 일반 독자를 위해 요약·해설한 것입니다. 특정 제품이나 요법을 권장하거나 홍보하지 않으며, 어떤 결과도 안전성이나 유효성의 근거로 제시하지 않습니다. 개인의 진단·치료·생활습관 변경에 관한 결정은 반드시 의료 전문가와 상의하시기 바랍니다. 원문의 해석에 오류가 있을 수 있으므로, 정확한 내용은 각 카드에 표기된 원 논문을 확인해 주세요.
